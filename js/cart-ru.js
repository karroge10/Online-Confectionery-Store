...
var t = document.createTextNode("Корзина пустая"); 
h.appendChild(t)
...
function quantityTextChanger(quantityText, number) {
    ...
    var txt = ['товар', 'товара', 'товаров']
    quantityText.innerHTML = txt[(number % 100 > 4 && number % 100 < 20) ? 2 : cases[(number % 10 < 5) ? number % 10 : 5]]
}
...
const menuDictionary = {
    "Berry Cake" : 'Торт Ягодный', 
    "Chocolate Cake" : 'Торт Шоколадный', 
    "Raspberry Tartlet (1 piece)" : 'Тарталетка с малиной (1 шт.)', 
    'Honey Cake' : 'Торт Медовик',
    "Napoleon Cake" : 'Торт Наполеон',
    'Торт Прага' : "Prague Cake", 
    "Chocolate Cheesecake" : 'Шоколадный Чизкейк', 
    "Eclair with berries (1 piece)" : 'Эклер Ягодный' , 
    "New York Cheesecake" :  'Чизкейк Нью-Йорк', 
    "Oreo Cake" : 'Торт Орео', 
    "Chocolate Muffins (6 pieces)" : 'Маффины Шоколадные (6 шт.)', 
    "Celebration Cake" : 'Торт Праздничный', 
    "Tiramisu Cheesecake (1 piece)" : 'Чизкейк Тирамису (1 шт.)', 
    "Pumpkin Cheesecake" : 'Торт Тыквенный', 
    "Avocado Cheesecake" : 'Чизкейк Авокадо', 
    "Rainbow Cheesecake" : 'Торт Радужный', 
    "Sweet rolls (1 piece)" : 'Сладкий рулет (1 шт.)', 
    "Carrot Cake" : 'Торт Морковный', 
    "Strawberry Cheesecake (1 piece)" : 'Чизкейк Клубничный (1 шт.)', 
    "Lingonberry Cheesecake" : 'Чизкейк Брусничный' , 
    "Caramel Cake" : 'Карамельный Торт', 
    "Macarons (6 pieces)" : 'Макаруны (6 шт.)'
}
